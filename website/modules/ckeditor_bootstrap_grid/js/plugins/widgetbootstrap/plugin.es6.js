      ...
      editor.widgets.add('widgetbootstrapTwoCol', {
        ...
        template:
                '<div class="row two-col">' +
                     '<div class="col-6 col-sm-6 col-md-6 col-first"><p><img src="https://placehold.it/500x280&text=Image" /></p><p>Content</p></div>' +
                     '<div class="col-6 col-sm-6 col-md-6 col-second"><p><img src="https://placehold.it/500x280&text=Image" /></p><p>Content</p></div>' +
                '</div>',
      ...
      editor.widgets.add('widgetbootstrapThreeCol', {
        ...
        template:
                '<div class="row three-col">' +
                     '<div class="col-4 col-sm-4 col-md-4 col-first"><p><img src="https://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>' +
                     '<div class="col-4 col-sm-4 col-md-4 col-second"><p><img src="https://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>' +
                     '<div class="col-4 col-sm-4 col-md-4 col-third"><p><img src="https://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>' +
                 '</div>',
